...
function MediaItem({ clickId }) {
    ...
    const [id, setId] = useState(clickId)
    ...
    return (
        <div className="media-item">
            ...
            <div className='modal-middle'>
                <img src={`https://firebasestorage.googleapis.com/v0/b/artchat-86d4b.appspot.com/o/images%2F${user?.id}%2F%20${id}?alt=media&token=96295942-b104-4f9d-b704-60c8e0f76b13`} alt="" />
            </div>
            <div
                onClick={() => nextPhoto()}
